...
void loop() {
  if(Serial3.available()>0) {
    ...
    switch (data){
      case 'a' : posisix+=7;posisiz+=7;break;
      case 'b' : posisix+=5;posisiz+=5;break;
      case 'c' : posisix+=3;posisiz+=3;break;
      case 'd' : posisix+=1;posisiz+=1;break;
      case 'e' : posisix+=0;break;
      case 'f' : posisix+=0;break;
      case 'g' : posisix-=1;posisiz-=1;break;
      case 'h' : posisix-=3;posisiz-=3;break;
      case 'i' : posisix-=5;posisiz-=5;break;
      case 'j' : posisix-=7;posisiz-=7;break;
